const urlCodes = {
  ...
  9130: { title: '系统设置', to: '/system/setting' },
  9031: { title: '邮件设置', to: '/system/setting/mail', omit: true },
  9032: { title: '短信设置', to: '/system/setting/sms', omit: true },
  9033: { title: '安全设置', to: '/system/setting/secure', omit: true },
